...
arline::GraphicsPipeline::GraphicsPipeline(Config&& config) noexcept
{
    ...
    auto const blendAttachmentState{ VkPipelineColorBlendAttachmentState{
        .blendEnable = ((config.flags & FlagBits::eColorBlending) == FlagBits::eColorBlending),
    ...
    auto const depthStencilStateCreateInfo{ VkPipelineDepthStencilStateCreateInfo{
        ...
        .depthTestEnable = ((config.flags & FlagBits::eDepthTest) == FlagBits::eDepthTest),
        .depthWriteEnable = ((config.flags & FlagBits::eDepthWrite) == FlagBits::eDepthWrite),
